...
public class VolunteerPostUserHelper {
    ...
    public VolunteerPostUserHelper(String title, String description, String dateActivity, String startTimeActivity, String endTimeActivity, String location, String address, String minimumAge, String maximumAge, String requirements, String contactNo, String points, String username) {
        this.title = title;
    ...
    public VolunteerPostUserHelper(){
